...
export function createEditorProjectState() {
  return {
    ...
    intent: {
      ...
      problemSituation: '', currentSolution: '', currentLimitation: '', improvementDirection: '',
...
export function toProjectDocument(state, processLog) {
  ...
  const planningData = {
    ...
    problemSituation: state.intent.problemSituation,
    existingSolution: state.intent.currentSolution,
    limitation: state.intent.currentLimitation,
    improvement: state.intent.improvementDirection,
...
export function fromProjectDocument(documentData = {}) {
  ...
  return {
    ...
    intent: {
      ...
      coreValues: asArray(p.coreValues).filter((value) => value !== '기타'), problemSituation: asText(p.problemSituation),
      currentSolution: asText(p.existingSolution), currentLimitation: asText(p.limitation),
      improvementDirection: asText(p.improvement), originalCoreFeatures: asText(p.originalCoreFeatures),
