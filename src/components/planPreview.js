...
function conditionalRows(state) {
  if (state.basic.projectType === '생활 문제 해결형') return [['해결하고 싶은 문제',state.intent.problemSituation],['개선하고 싶은 내용',state.intent.improvementDirection]]
  return []
}
